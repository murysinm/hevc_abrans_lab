...
public:
    ...
    struct BinRecord { uint8_t bit; int16_t ctxIdx; }; // ctxIdx: 0-159 regular, -1 EP, -2 Trm
    std::vector<BinRecord> m_abransBuf;
    uint16_t      m_abransVsw[161];
    uint16_t      m_abransCarryOverVsw[161];
    bool          m_abransCarryOver; 
    bool          m_isISlice;
